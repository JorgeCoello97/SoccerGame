    ...
    if(db.connect())
    {
      ...
      if(numData > 0){
        ...
        rect(width/2, height/2, widthTable,  heightTable);
         //HEADER
        Cell headerPlayer1 = new Cell((width/2)-(widthTable/2), (height/2)-(heightTable/2),(widthTable/2), heightRow, colorTable, "PLAYER 1");
        headerPlayer1.Draw();
        
        Cell headerPlayer2 = new Cell(headerPlayer1.nextCell(), (height/2)-(heightTable/2),(widthTable/2), heightRow, colorTable, "PLAYER 2");
        headerPlayer2.Draw();
        if (numData == 1){
          //VALUE #1
          db.next();
